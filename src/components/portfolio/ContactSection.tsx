        ...
        <div className="glass rounded-2xl p-8 md:p-12 glass-glow">
          ...
          <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <a
              ...
              className="group flex items-center gap-2 glass rounded-xl px-5 py-2.5 text-xs tracking-[0.15em] uppercase text-foreground hover:bg-primary/10 transition-all duration-300"
            >
