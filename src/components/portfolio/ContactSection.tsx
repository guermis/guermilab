...
const WHATSAPP_MESSAGE = encodeURIComponent('Olá! Vi seu portfólio e gostaria de conversar sobre um projeto.');
    ...
    <section id="contact" className="relative px-6 py-24 md:px-16 lg:px-24 border-t border-border">
      <div ref={ref} className={`mx-auto max-w-3xl text-center ${isInView ? 'animate-fade-in' : 'opacity-0'}`}>
        ...
        <p className="mx-auto mt-6 max-w-md text-sm leading-relaxed text-muted-foreground font-body">
          Interessado em colaborar? Preencha o formulário ou entre em contato
          diretamente.
        </p>
        ...
        <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
          <a
            ...
            className="group flex items-center gap-2 rounded-sm border border-border bg-secondary px-5 py-2.5 text-xs tracking-[0.15em] uppercase text-foreground hover:border-primary/40 hover:bg-primary/10 transition-all duration-300"
          >
